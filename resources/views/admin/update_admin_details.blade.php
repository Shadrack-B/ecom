                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $adminDetails->name }}"
                                        placeholder="Enter Name" name="admin_name" id="admin_name" required="">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Mobile</label>
                                    <input type="text" class="form-control" value="{{ $adminDetails->mobile }}"
                                        name="admin_mobile" id="admin_mobile" placeholder="Enter Admin Mobile"
                                        required="">
                                </div>
                                <div class="form-group">
                                    ...
                                    <a target="_blank"
                                        href="{{ url('images/admin_images/admin_photos/'.$adminDetails->image) }}">View
                                        Image</a>
                                    <input type="hidden" name="current_admin_name" value="$adminDetails->image">
                                    @endif
                                </div>
                            </div>
                            <!-- /.card-body -->
